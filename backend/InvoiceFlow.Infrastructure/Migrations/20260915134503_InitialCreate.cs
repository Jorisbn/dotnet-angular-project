        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApprovalSteps_Invoices_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AuditEntries_Invoices_InvoiceId",
                        column: x => x.InvoiceId,
                        principalTable: "Invoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApprovalSteps_InvoiceId_StepOrder",
                table: "ApprovalSteps",
                columns: new[] { "InvoiceId", "StepOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AuditEntries_InvoiceId_CreatedAt",
                table: "AuditEntries",
